...
import org.imaginativeworld.banners.databinding.ItemCarouselBinding
...
import kg.ram.banners.utils.CarouselItemDecoration
import kg.ram.banners.utils.dpToPx
import kg.ram.banners.utils.setImage
...
open class FiniteCarouselAdapter(
    ...
    private val cardCornerRadius: Int
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        if (holder.binding is ItemCarouselBinding) {
            ...
            holder.binding.card.radius = cardCornerRadius.dpToPx(holder.itemView.context).toFloat()
